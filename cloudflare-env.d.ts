/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 5caa200c96d5597d6bc0b1aa7f835afd)
...
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* cortex */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "AUTH_SECRET" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "ANTHROPIC_API_KEY">> {}
}
